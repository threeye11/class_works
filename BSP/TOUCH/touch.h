...
#define PEN   GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_1)
#define DOUT   GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_2)
#define TDIN(n) (n?GPIO_WriteBit(GPIOC, GPIO_Pin_3, Bit_SET):GPIO_WriteBit(GPIOC, GPIO_Pin_3, Bit_RESET))
#define TCLK(n) (n?GPIO_WriteBit(GPIOC, GPIO_Pin_0, Bit_SET):GPIO_WriteBit(GPIOC, GPIO_Pin_0, Bit_RESET))
#define TCS(n) (n?GPIO_WriteBit(GPIOC, GPIO_Pin_13, Bit_SET):GPIO_WriteBit(GPIOC, GPIO_Pin_13, Bit_RESET))

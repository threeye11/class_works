...
#define      macESP8266_USART_CLK                             RCC_APB1Periph_UART5
#define      macESP8266_USART_GPIO_APBxClock_FUN              RCC_APB2PeriphClockCmd
#define      macESP8266_USART_GPIO_CLK                        RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOC     
#define      macESP8266_USART_TX_PORT                         GPIOC   
#define      macESP8266_USART_TX_PIN                          GPIO_Pin_12
#define      macESP8266_USART_RX_PORT                         GPIOD
#define      macESP8266_USART_RX_PIN                          GPIO_Pin_2
